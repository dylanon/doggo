          ...
          <div className="wrapper">
            <Switch>
              ...
              <Route path='/history' render={(routeProps) => {
                return <Log {...routeProps} userID={this.state.userID} log={this.state.log} filterBy={this.state.filterBy} filterByName={this.state.filterByName} filterLog={this.filterLog} resetFilter={this.resetFilter} navToggleClass={this.state.navToggleClass} toggleNav={this.toggleNav}/>
              }} />
            </Switch>
          </div>
        </main>
